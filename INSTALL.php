...
if (!$db) {
    die('<br>Falsches SQL-Passwort! Bitte auf der vorherigen Seite korrigieren.');
}
...
?>';
	...
	if(fputs($file, $content_config)) $message = 'Konfiguration erfolgreich beendet!';
	else echo 'echec';
}
...
if (mysql_query($sql_database, $db)) {
    ...
    echo 'Fehler während dem Erstellen der Datenbank : ' . mysql_error() . "\n";
}
...
function changeAlert(){
	$('span.changeAlert').html('Diese Änderung wird ihre Datenbank löschen!');
}
