...
?>';
	...
	if(fputs($file, $content_config)) $message = 'Kofiguration erfolgreich bearbeitet!';
	else echo 'echec';
}
...
<div id="tabs" style="width:85%;margin-left:auto;margin-right:auto;min-height:400px;max-height:600px;overflow:auto;">
	...
	<div id="tabs-1">
		...
		<table>
			...
			<tr>
				<td><?php echo dbmovies;?></td><td><input type="radio" name="videobase" value="Allocine"  <?php if($MOVIES_DATABASE == 'Allocine') echo 'checked';?>>Filmstarts<input type="radio" name="videobase" value="TMDb" <?php if($MOVIES_DATABASE == 'TMDb') echo 'checked';?>>TMDb	<input type="hidden" name="oldvideobase" value="<?php echo $MOVIES_DATABASE;?>">
				</td>
			</tr>
			<tr>
				<td><?php echo dbseries;?></td><td><input type="radio" name="seriebase" value="Allocine" <?php if($SERIES_DATABASE == 'Allocine') echo 'checked';?>>Filmstarts<input type="radio" name="seriebase" value="TheTvDb" <?php if($SERIES_DATABASE == 'TheTvDb') echo 'checked';?> disabled>TheTvDb</td>
			</tr>
			<tr>
	...
	while($data = mysql_fetch_array($req)){
		if(!mb_ereg($SERIES_DIR,$data['dir'])){
			...
			<button value="Modifier">Bearbeiten</button></a></p>';
		}
	}
	?>
	</div>
	...
	echo '<table border="0">
			<tr><td style="text-align:center;color:#4183c4;">Datei</td><td style="text-align:center;color:#4183c4;">Verzeichnis</td><td style="text-align:center;color:#4183c4;">Fehler</td></tr>';
	}
	while($data = mysql_fetch_array($req)){
	...
	else echo '<img src="images/check.png">Kein Fehler entdeckt!';
	?>
	</div>
	</div>
