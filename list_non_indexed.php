...
if(count($renamed) > 0) {
echo 'Umbenannte Ordner und Dateien :<br>';
...
?>
<button id="index" value="indexer">Indexieren!</button>
...
else echo '<p style="text-align:center;width:100%;"><img src="images/check.png" alt="Ok">Alle Filme wurden verarbeitet</p>';
